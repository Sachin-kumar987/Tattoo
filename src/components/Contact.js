      ...
      <div className='flex flex-col xl:flex-row gap-y-16'>
        ...
        className='flex-1'>
          ...
          gap-x-5 gap-y-16 xl:gap-y-0'>
            {info.map((item, index) => {
              //destructure item
              const {title, subtitle, address, phone, 
                email, link } = item;
              return (
                // item
              <div key={index}>
                ...
                font-medium text-xl mb-3'>{title}</div>
                  {/* subtitle */}
                <div className='mb-6 text-[#333] 
                leading-[187%] tracking-[0.02em]'>{subtitle}</div>
                  {/* address, phone  & email */}
        ...
        justify-between items-center'>
          <form className='flex flex-col gap-y-10 w-full'>
            ...
            placeholder: text-[#555] italic tracking-[0.06em]
             outline-none pb-4 ' 
